  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <SectionCard testId="settings-azienda" title="Anagrafica società" action={<Building2 size={16} className="text-[#60A5FA]"/>}>
        ...
        <SectionCard testId="settings-target" title="Target di portafoglio" action={<Target size={16} className="text-[#34D399]"/>}>
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
      ...
      <SectionCard testId="settings-ai" title="Parametri AI Autopilot" subtitle="Personalizza il comportamento dell'assistente strategico" action={<Sparkles size={16} className="text-[#60A5FA]"/>} className="mb-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <span className="text-[10px] uppercase tracking-wider text-[#9CA3AF] font-medium">Propensione al rischio</span>
            <div className="mt-2 grid grid-cols-3 gap-2">
              {[
                { v: "bassa", l: "Conservativa", c: "#34D399" },
                { v: "media", l: "Bilanciata", c: "#60A5FA" },
                { v: "alta", l: "Aggressiva", c: "#FBBF24" },
              ].map(o => (
                <button
                  key={o.v}
                  data-testid={`risk-${o.v}`}
                  onClick={() => setPropensione(o.v)}
                  className={`px-3 py-2.5 rounded-lg text-sm border transition-colors ${propensione === o.v ? "border-[#0066FF] bg-[rgba(0,102,255,0.1)] text-[#60A5FA]" : "border-[#212B36] text-[#9CA3AF] hover:border-[#334155]"}`}
                >
                  {o.l}
                </button>
              ))}
          ...
          <div>
            <span className="text-[10px] uppercase tracking-wider text-[#9CA3AF] font-medium">Strategia preferita</span>
            <div className="mt-2 grid grid-cols-3 gap-2">
              {[
                { v: "affitto", l: "Reddito" },
                ...
                <button
                  ...
                  className={`px-3 py-2.5 rounded-lg text-sm border transition-colors ${strategia === o.v ? "border-[#0066FF] bg-[rgba(0,102,255,0.1)] text-[#60A5FA]" : "border-[#212B36] text-[#9CA3AF] hover:border-[#334155]"}`}
                >
                  {o.l}
                </button>
              ))}
      ...
      <SectionCard testId="settings-user" title="Account & ruoli" action={<Shield size={16} className="text-[#FBBF24]"/>}>
        <div className="flex items-center gap-4 p-3 bg-[#080C11] border border-[#212B36] rounded-lg">
          ...
          <div>
            ...
            <div className="text-[10px] uppercase tracking-wider mt-1 text-[#60A5FA]">Ruolo: {user?.role}</div>
          </div>
        </div>
      </SectionCard>
    </Layout>
