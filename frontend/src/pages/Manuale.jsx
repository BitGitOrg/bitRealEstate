...
const SECTIONS = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "text", text: "Nella tab Locazione di ogni immobile puoi inserire email + numero WhatsApp dell'inquilino. Il sistema scansiona giornalmente gli incassi non pagati e categorizza in 3 livelli: T+5 giorni (sollecito cortese), T+15 giorni (sollecito fermo), T+30 giorni (intimazione)." },
